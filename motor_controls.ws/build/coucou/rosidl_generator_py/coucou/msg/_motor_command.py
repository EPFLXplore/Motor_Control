...
class Metaclass_MotorCommand(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('coucou')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'coucou.msg.MotorCommand')
            logger.debug(
...
class MotorCommand(metaclass=Metaclass_MotorCommand):
    ...
    def __init__(self, **kwargs):
        ...
        self.commande = kwargs.get('commande', float())
    ...
    def commande(self, value):
        if __debug__:
            assert \
                ...
                "The 'commande' field must be of type 'float'"
