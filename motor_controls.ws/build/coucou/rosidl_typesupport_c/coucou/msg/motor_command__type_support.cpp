...
#include "coucou/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _MotorCommand_type_support_symbol_names_t _MotorCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, coucou, msg, MotorCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, coucou, msg, MotorCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_coucou
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, coucou, msg, MotorCommand)() {
  return &::coucou::msg::rosidl_typesupport_c::MotorCommand_message_type_support_handle;
}
