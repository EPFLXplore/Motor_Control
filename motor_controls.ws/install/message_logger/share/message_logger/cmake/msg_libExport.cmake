...
foreach(_expectedTarget message_logger::msg_lib)
...
# Create imported target message_logger::msg_lib
add_library(message_logger::msg_lib SHARED IMPORTED)
...
file(GLOB CONFIG_FILES "${_DIR}/msg_libExport-*.cmake")
