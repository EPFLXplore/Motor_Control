...
{
  new (message_memory) motor_control_interfaces::msg::MotorData(_init);
}

void MotorData_fini_function(void * message_memory)
{
  auto typed_message = static_cast<motor_control_interfaces::msg::MotorData *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MotorData_message_member_array[4] = {
  {
    ...
    offsetof(motor_control_interfaces::msg::MotorData, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(motor_control_interfaces::msg::MotorData, position),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(motor_control_interfaces::msg::MotorData, velocity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(motor_control_interfaces::msg::MotorData, currant),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MotorData_message_members = {
  ...
  4,  // number of fields
  sizeof(motor_control_interfaces::msg::MotorData),
...
{
  return &::motor_control_interfaces::msg::rosidl_typesupport_introspection_cpp::MotorData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, motor_control_interfaces, msg, MotorData)() {
  return &::motor_control_interfaces::msg::rosidl_typesupport_introspection_cpp::MotorData_message_type_support_handle;
}
