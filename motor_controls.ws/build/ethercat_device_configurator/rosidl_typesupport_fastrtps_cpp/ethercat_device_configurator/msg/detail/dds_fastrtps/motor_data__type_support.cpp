...
#include "ethercat_device_configurator/msg/detail/motor_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const ethercat_device_configurator::msg::MotorData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ethercat_device_configurator::msg::MotorData *>(
    untyped_ros_message);
...
{
  return &ethercat_device_configurator::msg::typesupport_fastrtps_cpp::_MotorData__handle;
}
