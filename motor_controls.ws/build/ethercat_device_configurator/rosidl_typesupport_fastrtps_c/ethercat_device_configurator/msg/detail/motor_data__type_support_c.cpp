...
#include "ethercat_device_configurator/msg/detail/motor_data__rosidl_typesupport_fastrtps_c.h"
...
using _MotorData__ros_msg_type = ethercat_device_configurator__msg__MotorData;
...
size_t get_serialized_size_ethercat_device_configurator__msg__MotorData(
  const void * untyped_ros_message,
...
static uint32_t _MotorData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ethercat_device_configurator__msg__MotorData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ethercat_device_configurator
size_t max_serialized_size_ethercat_device_configurator__msg__MotorData(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_ethercat_device_configurator__msg__MotorData(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ethercat_device_configurator, msg, MotorData)() {
