...
#include "motor_control_interfaces/msg/detail/motor_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const motor_control_interfaces::msg::MotorCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  motor_control_interfaces::msg::MotorCommand & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
...
{
  auto typed_message =
    static_cast<const motor_control_interfaces::msg::MotorCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<motor_control_interfaces::msg::MotorCommand *>(
    untyped_ros_message);
...
{
  return &motor_control_interfaces::msg::typesupport_fastrtps_cpp::_MotorCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motor_control_interfaces, msg, MotorCommand)() {
  return &motor_control_interfaces::msg::typesupport_fastrtps_cpp::_MotorCommand__handle;
}
