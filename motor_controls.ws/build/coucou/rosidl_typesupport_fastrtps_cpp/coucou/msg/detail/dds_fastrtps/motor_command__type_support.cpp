...
#include "coucou/msg/detail/motor_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const coucou::msg::MotorCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<coucou::msg::MotorCommand *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_coucou
const rosidl_message_type_support_t *
get_message_type_support_handle<coucou::msg::MotorCommand>()
{
  return &coucou::msg::typesupport_fastrtps_cpp::_MotorCommand__handle;
}
