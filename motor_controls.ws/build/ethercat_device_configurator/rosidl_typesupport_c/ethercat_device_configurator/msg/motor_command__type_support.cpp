...
#include "ethercat_device_configurator/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _MotorCommand_type_support_symbol_names_t _MotorCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ethercat_device_configurator, msg, MotorCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ethercat_device_configurator, msg, MotorCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_ethercat_device_configurator
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ethercat_device_configurator, msg, MotorCommand)() {
  return &::ethercat_device_configurator::msg::rosidl_typesupport_c::MotorCommand_message_type_support_handle;
}
