...
#include <stddef.h>
#include "coucou/msg/detail/motor_command__rosidl_typesupport_introspection_c.h"
#include "coucou/msg/rosidl_typesupport_introspection_c__visibility_control.h"
...
static rosidl_typesupport_introspection_c__MessageMember MotorCommand__rosidl_typesupport_introspection_c__MotorCommand_message_member_array[3] = {
  {
    ...
    offsetof(coucou__msg__MotorCommand, name),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(coucou__msg__MotorCommand, mode),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(coucou__msg__MotorCommand, commande),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers MotorCommand__rosidl_typesupport_introspection_c__MotorCommand_message_members = {
  "coucou__msg",  // message namespace
  "MotorCommand",  // message name
  3,  // number of fields
  sizeof(coucou__msg__MotorCommand),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_coucou
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, coucou, msg, MotorCommand)() {
