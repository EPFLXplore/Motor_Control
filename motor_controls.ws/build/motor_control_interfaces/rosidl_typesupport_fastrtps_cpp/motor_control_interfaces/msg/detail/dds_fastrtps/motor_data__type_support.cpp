...
#include "motor_control_interfaces/msg/detail/motor_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const motor_control_interfaces::msg::MotorData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<motor_control_interfaces::msg::MotorData *>(
    untyped_ros_message);
...
{
  return &motor_control_interfaces::msg::typesupport_fastrtps_cpp::_MotorData__handle;
}
